...
<body>
    <div class="container py-2 d-flex font-roboto">
        <a href="{{ route('frontent.home') }}" class="d-flex">
            <div class="mr-2">
                <img src="{{ asset(config('constants.nep_gov.logo_sm')) }}" alt="" style="max-height: 90px;">
            </div>
            <div class="d-flex flex-column align-self-center">
                <h4 class="h4-responsive text-danger font-weight-bold">{{ __('app.name') }}</h4>
