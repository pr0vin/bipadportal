        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card z-depth-0 mb-3" style="border: 1px solid #ededed;">
                    <form action="{{ $position->id ? route('position.update', $position) : route('position.store') }}"
                        method="POST">
                        @csrf
                        @isset($position->id)
                            @method('put')
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <button class="btn my-0 rounded z-depth-0 font-16px py-2 px-4"
                                    style="background-color:#374f67; color: #fff;">{{ $position->id ? 'अपडेट गर्नुहोस्' : 'पेश गर्नुहोस्' }}</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-lg-8">
                <div class="card z-depth-0">
                    <div class="card-body">
                        ...
                        @php
                            $positions = App\Position::latest()->paginate(5);
                        @endphp
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <div class="d-flex justify-content-center">
                                                <a href="{{route('position.edit',$position)}}" class="text-warning"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('position.edit', $position) }}">सम्पादन</a>
                                                    <form action="{{ route('position.delete', $position) }}" method="POST"
                                                        onsubmit="return confirm('के तपाइँ यो रेकर्ड मेटाउन निश्चित हुनुहुन्छ ?')">
                                                        @csrf
                                                        @method('delete')
