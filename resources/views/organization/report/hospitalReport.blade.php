        ...
        <div class="card z-depth-0 printableCard">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end notPrintable">
                    <button type="button" class="mr-2 bg-transparent border-0" id="report_print"><i class="fa fa-print"
                            aria-hidden="true"></i>
                        Print</button>
                    @php
                ...
                <div id="printReport" class="m-0 p-0">
                    ...
                    <div clas="">
                        @if (Session()->get('municipality_id'))
                            <h3 class="text-center font-weight-bold kalimati-font">
                                {{ App\Organization::where('address_id', Session()->get('municipality_id'))->first()->address->municipality }}</h3>
