<div class="d-flex notPrintable">
    <a href="{{ route('organization.hospitalWiseReport') }}"
        class="btn {{ \Request::route()->getName() == 'organization.hospitalWiseReport' ? 'btn-info' : 'btn-transparent' }} border py-2"
        style="box-shadow: none">अस्पताल अनुसार रिपोर्ट</a>
    <a href="{{ route('organization.diseaseWiseReport') }}?diseaseType=2"
        class="btn {{ \Request::route()->getName() == 'organization.diseaseWiseReport' ? 'btn-info' : 'btn-transparent' }} border py-2"
        style="box-shadow: none">रोग अनुसार रिपोर्ट</a>
</div>
