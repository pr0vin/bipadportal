            ...
            <div class="card mt-4 z-depth-0">
                ...
                <div class="card-body">
                    ...
                    {{-- <div class="input-group mb-3">
                        ...
                        <h5 for="" class="font-weight-bold kalimati-font">१. विपद्‌ पीडित राहत सूचीको लागि निवेदन दिने व्यक्तिको विवरण :</h5>
                        ...
                        <section class="mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 mb-2">
                                    <label for="" class="required"> पीडितसँगको नाता <span class="text-danger">*</span></label>
                       ...
                       <div class="mt-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input  type="number"  name="estimated_amount" class="form-control kalimati-font" id="estimated_amount" required>
                            </div>
                            ...
                            <section class="mt-3">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="addFile()">+ Add More</button>
                                         <script>
                                            function addFile() {
