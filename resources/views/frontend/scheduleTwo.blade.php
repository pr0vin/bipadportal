    ...
    <div>
        <div class="p-4 resizable-block">
            <section>
                ...
                <h4 class="font-weight-bold text-center">अनुसूची–२</h4>
                <h4 class="font-weight-bold text-center">(विपद् राहत तथा सहयोगसम्बन्धी)</h4>

                <h5 class="font-weight-bold col-12 text-center">
                    विपद्/आकस्मिक अवस्थाबाट प्रभावित भएकाले राहत एवं सहयोग प्राप्त गर्न पेश गरिने निवेदनको ढाँचा
                </h5>
