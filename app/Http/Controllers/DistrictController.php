...
class DistrictController extends Controller
{
    ...
    public function getMunicipality($districtId){
        ...
        // $municipalities=Organization::where('district_id',$districtId)->with('municipality')->latest()->get();
        return response()->json($municipalities);
    }

    public function getward($municipalityId){
        $ward=Address::where('municipality',$municipalityId)->first();
