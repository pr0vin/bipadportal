...
class OrganizationService
{
    public function all()
    {
        $patients = $this->getOrPatientPipeline()
            ->with(['onlineApplication', 'province', 'district', 'municipality'])
        ...
        return $patients->paginate(request('per_page') ?? config('constants.organization.per_page'));
    }

    public function getOrPatientPipeline()
    {
    ...
    {
        return $organization->load(['onlineApplication', 'address','patientApplication.application_type','renews']);
    }
